...
describe("unshift", () => {
  const getOp = (value: any) => {
    ...
    unshift(
      ...
      { changeValue, resetFieldState } as unknown as Tools,
    );
  ...
  it("should insert value to beginning of array", () => {
    ...
    const resetFieldState: Tools["resetFieldState"] = (name) => {
      state.fields[name as keyof typeof state.fields].touched = false;
    };
